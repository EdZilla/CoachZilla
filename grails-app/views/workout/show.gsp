...
<html>
    ...
    <body>
        ...
        <div id="show-workout" class="content scaffold-show" role="main">
            ...
            <f:display bean="workout" />
            </ol>
            <g:form resource="${workout}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${workout}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
